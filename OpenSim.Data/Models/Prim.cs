...
namespace OpenSim.Data.Models
{
    public partial class Prim
    {
        ...
        public byte ForceMouselook { get; set; }
        public int ScriptAccessPin { get; set; }
        public byte AllowedDrop { get; set; }
        public byte DieAtEdge { get; set; }
        ...
        public byte PassTouches { get; set; }
        ...
        public byte PassCollisions { get; set; }
